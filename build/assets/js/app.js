...
var _h5dsInitpc = __webpack_require__(562);
...
$(function () {
    ...
    try {
        ...
        if (!(0, _h5dsUtils.isPC)()) {
            ...
            // 禁用safari浏览器的 默认滚动
            var stopScrolling = function stopScrolling(touchEvent) {
...
var _h5dsWave = __webpack_require__(563);
